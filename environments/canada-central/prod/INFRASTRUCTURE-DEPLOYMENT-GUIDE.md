...
- **Notes**:
  ...
  - Service endpoints allow direct access to Azure services without going through firewall
...
1. **Resource in Subnet** (e.g., AKS node)
2. **Service Endpoint** (Direct connection to Azure service)
3. **Azure Service** (Storage, Key Vault, SQL, ACR)
4. **Note**: Traffic stays on Azure backbone, doesn't go through firewall
...
6. **Service endpoints**: Allow direct access to Azure services without firewall

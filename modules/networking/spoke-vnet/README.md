...
Enabled service endpoints for AKS subnets:
- `Microsoft.Storage` - Azure Storage access
- `Microsoft.Sql` - Azure SQL/PostgreSQL access
- `Microsoft.KeyVault` - Key Vault access
- `Microsoft.ContainerRegistry` - ACR access
...
- **Service Endpoints**: Improve performance and security for Azure PaaS access
